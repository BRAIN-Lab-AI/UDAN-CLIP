...
def calculate_all_metrics(img1, img2):
    """Calculate all metrics (PSNR, SSIM, UIQM, UCIQE, CPBD) at once"""
    ...
    uiqm_val = uiqm(img1)
    uciqe_val = uciqe(img1)
    cpbd_val = compute_cpbd(img1)
    
    return psnr_val, ssim_val, uiqm_val, uciqe_val, cpbd_val
